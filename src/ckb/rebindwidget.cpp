    ...
    bind(0), profile(0)
{
    ...
    fnKeys << "esc" << "f1" << "f2" << "f3" << "f4" << "f5" << "f6" << "f7" << "f8" << "f9" << "f10" << "f11" << "f12" << "prtscn" << "scroll" << "pause" << "f13" << "f14" << "f15" << "f16" << "f17" << "f18" << "f19" << "f20" << "ins" << "del" << "home" << "end" << "pgup" << "pgdn" << "power" << "lightup" << "lightdn" << "up" << "down" << "left" << "right" << "SunProps" << "SunFront" << "SunCut" << "SunOpen" << "SunPaste" << "SunCopy" << "SunStop" << "SunAgain" << "SunFind" << "Undo"  << "G3" << "G6" << "G9" << "G12" << "G15" << "G18" << "G16"<< "G17";
